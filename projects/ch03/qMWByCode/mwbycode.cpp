...
MWByCode::MWByCode(QWidget *parent)
    : QMainWindow(parent)
{
...
void MWByCode::closeEvent(QCloseEvent *event)
{
    if (okToContinue()) {
        writeSettings();
        event->accept();
...
void MWByCode::updateStatusBar()
{
    locationLabel->setText(spreadsheet->currentLocation());
    formulaLabel->setText(spreadsheet->currentFormula());
}

void MWByCode::spreadsheetModified()
{
    setWindowModified(true);
    updateStatusBar();
}

void MWByCode::createActions()
{
...
void MWByCode::createContextMenu()
{
...
bool MWByCode::loadFile(const QString &fileName)
{
...
bool MWByCode::saveFile(const QString &fileName)
{
...
void MWByCode::setCurrentFile(const QString &fileName)
{
    curFile = fileName;
...
void MWByCode::updateRecentFileActions()
{
...
QString MWByCode::strippedName(const QString &fullFileName)
{
